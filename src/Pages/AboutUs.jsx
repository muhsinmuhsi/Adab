    ...
    <div>
        <div className='bg-slate-200 pb-12'>
            ...
            <div className='bg-white my-11 m-5 flex flex-col items-center p-5 rounded-xl'>
                ...
                <p className='text-wrap pt-3 p-5'>Welcome to <strong>Adab</strong>, your one-stop destination for everything you need!
                     We offer a wide range of products, from daily essentials to exclusive deals, all at unbeatable prices.
                      With free shipping across India and we ensure a seamless shopping experience.
                </p>
                <p className='text-wrap p-5'>At <strong>Adab</strong>, we prioritize quality, affordability, and customer satisfaction. Whether you’re looking for groceries, fashion, electronics,
                ...
                <p className='font-semibold'>Adab -,Your Smart Shopping Destination!</p>
