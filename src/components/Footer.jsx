      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-dark-light">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-light-dark hover:text-primary">Home</Link>
              </li>
              <li>
                <Link to="/products" className="text-light-dark hover:text-primary">Products</Link>
              </li>
              <li>
                <Link to="/AboutUs" className="text-light-dark hover:text-primary">About Us</Link>
              </li>
              <li>
                <Link to="/privacy_Policy" className="text-light-dark hover:text-primary">Privacy Policy</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-light-dark">Chemmad-Thalappara Rd, Moonniyur, Malappuram, Kerala 676311</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 text-primary flex-shrink-0 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-light-dark"><a>adabcollections0372@gmail.com</a></span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 text-primary flex-shrink-0 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-light-dark">+91 8589868486</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-dark-light text-center">
          <p className="text-light-dark">
            ...
            className='inline p-1 mb-1'/>&copy; {new Date().getFullYear()} Adab. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
